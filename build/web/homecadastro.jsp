...
<html>
    <head>
        ...
        <title>Gerenciamento de Redações</title>
    </head>
    <body>
        ...
        ${message}
        <hr>
        <h2 align="center">Controle de Redações</h2>
        <p align="right"><a href="EncerrarSessao">Sair</a></p>
        <p align="center"><a href="cadastrarprofessor.jsp">Cadastrar professor</a></p>
        <p align="center"><a href="cadastraraluno.jsp">Cadastrar aluno</a></p>
