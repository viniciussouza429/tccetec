 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirPofessor", urlPatterns = {"/ExcluirPofessor"})
public class ExcluirPofessor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int idPessoa = Integer.parseInt(request.getParameter("idUsuario"));
            ...
            try{
                ...
                if(dao.excluir(idPessoa)){
                    ...
                    mensagem = "Problemas ao excluir professor!";
                }
                request.setAttribute("mensagem", mensagem);
                request.getRequestDispatcher("ListarProfessor").forward(request, response);
            }catch(Exception e){
                System.out.println("Problemas no Servlet ao excluir o professor! Erro: " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
