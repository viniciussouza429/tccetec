...
import br.com.projetoredatec.dao.MencaoDAOImpl;
...
@WebServlet(name = "CadastrarMencao", urlPatterns = {"/CadastrarMencao"})
public class CadastrarMencao extends HttpServlet {

    
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
            
            String nomeMencao = request.getParameter("nomeMencao");
            String descMencao = request.getParameter("descMencao");

            String mensagem = null;

            Mencao mencao = new Mencao();
            mencao.setNomeMencao(nomeMencao);
            mencao.setDescMencao(descMencao);
            
            try {
                GenericDAO dao = new MencaoDAOImpl();
