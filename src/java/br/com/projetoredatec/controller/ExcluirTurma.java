 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirTurma", urlPatterns = {"/ExcluirTurma"})
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if(dao.excluir(idPessoa)){
                    ...
                    mensagem = "Problemas ao excluir turma!";
                }
                request.setAttribute("mensagem", mensagem);
                request.getRequestDispatcher("ListarTurma").forward(request, response);
            }catch(Exception e){
                System.out.println("Problemas no Servlet ao excluir o turma! Erro: " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
